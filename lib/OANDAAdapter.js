...
OandaAdapter.prototype.deleteOrder = function (accountId, orderId, callback) {
...
OandaAdapter.prototype.updateTrade = function (accountId, tradeId, data, callback) {
...
OandaAdapter.prototype.getPositions = function (accountId, callback) {
...
OandaAdapter.prototype.closePosition = function (accountId, instrument, callback) {

    this._sendRESTRequest({
        method: "DELETE",
        path: "/v1/accounts/" + accountId + "/positions/" + instrument
    }, function (error, body, statusCode) {
        if (error) {
            if (body && body.message) {
                console.error("[ERROR] Response from Oanda", statusCode + " Error: " + body.message + " (OANDA error code " + body.code + ")");
...
OandaAdapter.prototype.getTransation = function (accountId, transactionId, callback) {
